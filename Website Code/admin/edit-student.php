...
if (
    ...
    if ($_SESSION['role'] == 'Admin') {
        ...
        $student = studentById($student_id, $connect);
...
<div class="back">
    <a href="student.php" class="back">Go Back</a></div>
<form method="post" class="edit" action="student-functions/edit-student.php">
    <h3>Edit student</h3>
    <hr>
    <?php
    if (isset($_GET['error'])) {
...
<form method="post"
              class="edit" 
              action="student-functions/password-student.php"
              id="change_password">
