<?php
function getTeacherById($connect, $teacher_id) {
...
if (isset($_SESSION['teacher_id']) && isset($_SESSION['role']) && $_SESSION['role'] == 'Teacher') {
    ...
    $loggedInTeacherId = $_SESSION['teacher_id'];
    $loggedInTeacher = getTeacherById($connect, $loggedInTeacherId);
} else {
        ...
        <div class="card overflow-hidden">
            <div class="row no-gutters row-bordered row-border-light">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="account-general">
                            <div class="card-body media align-items-center">
                                <?php if (!empty($teachers[0]['img'])) : ?>
                                    <img src="<?= $teachers[0]['img'] ?>" alt="Profile Picture" class="d-block ui-w-80 rounded-circle">
                                <?php endif; ?>
                ...
                <h3>
                    ...
                    <span><?= $loggedInTeacher['username'] ?></span>
                </h3>
            </div>
            ...
            <div class="form-group">
                <h3>
                    ...
                    <span><?= $loggedInTeacher['first_name'] ?></span>
                </h3>
            </div>
            ...
            <div class="form-group">
                <h3>
                    ...
                    <span><?= $loggedInTeacher['last_name'] ?></span>
                </h3>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <h3>
                    ...
                    <span><?= $loggedInTeacher['phone'] ?></span>
                </h3>
            </div>
            <div class="form-group">
                <h3>
                    <label class="form-label">Date of Birth:</label>
                    <span><?= $loggedInTeacher['date_of_birth'] ?></span>
                </h3>
            </div>
            ...
            <div class="form-group">
                <h3>
                    ...
                    <span><?= $loggedInTeacher['date_of_joined'] ?></span>
                </h3>
            </div>

            
            <div class="form-group">
            <form method="post" action="password-teacherfunc.php" id="change_password">
...
<?php } ?>
    ...
    <input type="hidden" value="<?= $loggedInTeacher['teacher_id'] ?>" name="teacher_id">
