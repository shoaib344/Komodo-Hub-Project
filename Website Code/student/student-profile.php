<?php
function getStudentById($connect, $student_id) {
...
if (isset($_SESSION['student_id']) && isset($_SESSION['role']) && $_SESSION['role'] == 'Student') {
    ...
    $loggedInStudent = getStudentById($connect, $loggedInStudentId);
} else {
        ...
        <div class="card overflow-hidden">
            <div class="row no-gutters row-bordered row-border-light">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="account-general">
                            <div class="card-body media align-items-center">
                                <?php if (!empty($students[0]['img'])) : ?>
                                    <img src="<?= $students[0]['img'] ?>" alt="Profile Picture" class="d-block ui-w-80 rounded-circle">
                                <?php endif; ?>
                ...
                <h3>
                    ...
                    <span><?= $loggedInStudent['username'] ?></span>
                </h3>
            </div>
            ...
            <div class="form-group">
                <h3>
                    ...
                    <span><?= $loggedInStudent['first_name'] ?></span>
                </h3>
            </div>
            ...
            <div class="form-group">
                <h3>
                    ...
                    <span><?= $loggedInStudent['last_name'] ?></span>
                </h3>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <h3>
                    ...
                    <span><?= $loggedInStudent['date_of_birth'] ?></span>
                </h3>
            </div>
            ...
            <div class="form-group">
                <h3>
                    ...
                    <span><?= $loggedInStudent['gender'] ?></span>
                </h3>
            </div>
            ...
            <div class="form-group">
                <h3>
                    ...
                    <span><?= $loggedInStudent['date_of_joined'] ?></span>
                </h3>
            </div>

            
            <div class="form-group">
            <form method="post" action="password-studentfunc.php" id="change_password">
...
<?php } ?>
    ...
    <input type="hidden" value="<?= $loggedInStudent['student_id'] ?>" name="student_id">
